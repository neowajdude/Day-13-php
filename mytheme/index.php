    ...
    <section class="mt-3 default">
        <div class="row">
            <div class="col-lg-8 left_part">
                <div class="banner">
                    <a href="#"><img class="p-2 border border-1 border-danger w-100" src="doc/images/banner/padmabanner.jpg" alt=""></a>
                </div>
                    ...
                    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img src="doc/images/slider/corona_banner.jpg" class="d-block w-100" alt="...">
                          </div>
                          <div class="carousel-item">
                            <img src="doc/images/slider/4-02.jpg" class="d-block w-100" alt="...">
                          </div>
                          <div class="carousel-item">
                            <img src="doc/images/slider/0.jpg" class="d-block w-100" alt="...">
                          </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 right_par">
                <div class="sidebar common">
                    <a href="#"><img class="w-100" src="doc/images/sidebar/bangladesh-portal--batton-bangla.png" alt=""></a>
                    <a href="#"><img class="w-100" src="doc/images/sidebar/discount_bn.jpg" alt=""></a>
                    <a href="#"><img class="w-100" src="doc/images/sidebar/Bangladesh-Directory.jpg" alt=""></a>
                    <a href="#"><img class="w-100" src="doc/images/sidebar/Jonotar-Sorkar-banner-Bangl (1).jpg" alt=""></a>
                    <a href="#"><img class="w-100" src="doc/images/sidebar/mygov_bn.jpg" alt=""></a>
                    <a href="#"><img class="w-100" src="doc/images/sidebar/Tamplate_guard_bn.png" alt=""></a>
                    <a href="#"><img class="w-100" src="doc/images/sidebar/Tamplate_govtjob_bn.png" alt=""></a>
                </div>
